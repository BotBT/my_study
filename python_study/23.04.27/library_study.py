...
"""
# color = ["베이지", "블랙", "블루", "회색", "청색", "레드", "파란", "핑크", "그레이"]
# band_name = ["쭈꾸미", "요거트", "오란다", "와플", "아이스티", "떡볶이", "커피"]
# band = [color, band_name]
# for i in range(2):
#    random.value = (random.choice(color, band_name))
#    if random.value not in band:
#       band.append()
# print(band)
